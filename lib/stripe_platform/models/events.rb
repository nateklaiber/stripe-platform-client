  ...
  module Models
    class Events
      ...
      def self.list(params={}, &block)
        request = StripePlatform::Requests::Events.list(params, &block)
      ...
      def self.retrieve(id, &block)
        request = StripePlatform::Requests::Events.retrieve(id, &block)

        request.on(:success) do |resp|
          response_body = resp.body

          return StripePlatform::Models::Event.new(response_body)
        end
      ...
      def internal_collection
        @collection.map { |record| StripePlatform::Models::Event.new(record) }
      end
    end
  end
end
