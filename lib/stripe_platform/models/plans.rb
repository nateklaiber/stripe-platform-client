  ...
  module Models
    class Plans
      ...
      def self.list(params={}, &block)
        request = StripePlatform::Requests::Plans.list(params, &block)
      ...
      def self.create(record_attributes, params={}, &block)
        request = StripePlatform::Requests::Plans.create(record_attributes, params, &block)

        request.on(:success) do |resp|
          response_body = resp.body

          return StripePlatform::Models::Plan.new(response_body)
        end
      ...
      def self.update(id, record_attributes={}, params={}, &block)
        request = StripePlatform::Requests::Plans.update(id, record_attributes, params, &block)
      ...
      def internal_collection
        @collection.map { |record| StripePlatform::Models::Plan.new(record) }
      end
    end
  end
end
