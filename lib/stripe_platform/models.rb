...
require File.expand_path('../models/error_types', __FILE__)
require File.expand_path('../models/error_type', __FILE__)
...
require File.expand_path('../models/payment_intent_statuses', __FILE__)
require File.expand_path('../models/payment_intent_status', __FILE__)
...
require File.expand_path('../models/coupon', __FILE__)

require File.expand_path('../models/plans', __FILE__)
require File.expand_path('../models/plan', __FILE__)

require File.expand_path('../models/invoice_statuses', __FILE__)
