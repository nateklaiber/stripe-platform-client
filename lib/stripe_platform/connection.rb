...
module StripePlatform
  class Connection < SimpleDelegator
    ...
    #
    # @example
    #   connection = StripePlatform::Connection.new(url: 'http://example.com') do |conn|
    #     conn.adapter(StripePlatform::Connection.default_adapter)
    #   end
    #
    #   @connection.headers['Authorization'] = "Bearer 1234"
    #
    # @return [StripePlatform::Connection] Faraday Connection Delegator
