  ...
  module Requests
    class InvoiceItems
      ...
      def self.list(params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::InvoiceItems.new(params)

        route = StripePlatform::Client.routes.route_for('invoice-items')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::InvoiceItem.new(record_attributes)

        route = StripePlatform::Client.routes.route_for('invoice-item')
