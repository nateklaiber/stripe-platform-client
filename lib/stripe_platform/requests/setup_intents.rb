  ...
  module Requests
    class SetupIntents
      ...
      def self.list(params={}, &block)
        ...
        route = StripePlatform::Client.routes.route_for('setup-intents')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::SetupIntent.new(record_attributes)
      ...
      def self.retrieve(id, params={}, &block)
        ...
        route = StripePlatform::Client.routes.route_for('setup-intent')
