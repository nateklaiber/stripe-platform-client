  ...
  module Requests
    class Products
      ...
      def self.list(params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Products.new(params)

        route = StripePlatform::Client.routes.route_for('products')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Product.new(record_attributes)

        route = StripePlatform::Client.routes.route_for('product')
