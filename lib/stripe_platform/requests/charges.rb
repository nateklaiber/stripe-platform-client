  ...
  module Requests
    class Charges
      ...
      def self.list(params={}, &block)
        ...
        route = StripePlatform::Client.routes.route_for('charges')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Charge.new(record_attributes)
      ...
      def self.retrieve(id, params={}, &block)
        ...
        route = StripePlatform::Client.routes.route_for('charge')
