  ...
  module Requests
    class Invoices
      ...
      def self.list(params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Invoices.new(params)

        route = StripePlatform::Client.routes.route_for('invoices')
      ...
      def self.upcoming(params={}, &block)
        ...
        route = StripePlatform::Client.routes.route_for('invoices-upcoming')
        url   = route.url_for(request_model.as_original_attributes)
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Invoice.new(record_attributes)

        route = StripePlatform::Client.routes.route_for('invoice')
