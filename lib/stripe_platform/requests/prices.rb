  ...
  module Requests
    class Prices
      ...
      def self.list(params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Prices.new(params)

        route = StripePlatform::Client.routes.route_for('prices')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Price.new(record_attributes)

        route = StripePlatform::Client.routes.route_for('price')
