  ...
  module Requests
    class SubscriptionItems
      ...
      def self.list(params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::SubscriptionItems.new(params)

        route = StripePlatform::Client.routes.route_for('subscription-items')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::SubscriptionItem.new(record_attributes)

        route = StripePlatform::Client.routes.route_for('subscription-item')
