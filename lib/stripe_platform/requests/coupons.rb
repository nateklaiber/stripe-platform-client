  ...
  module Requests
    class Coupons
      ...
      def self.list(params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Coupons.new(params)

        route = StripePlatform::Client.routes.route_for('coupons')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::Coupon.new(record_attributes)

        route = StripePlatform::Client.routes.route_for('coupon')
