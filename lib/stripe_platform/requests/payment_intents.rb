  ...
  module Requests
    class PaymentIntents
      ...
      def self.list(params={}, &block)
        ...
        route = StripePlatform::Client.routes.route_for('payment-intents')
      ...
      def self.create(record_attributes={}, params={}, &block)
        ...
        request_model = StripePlatform::Requests::Models::PaymentIntent.new(record_attributes)
      ...
      def self.retrieve(id, params={}, &block)
        ...
        route = StripePlatform::Client.routes.route_for('payment-intent')
